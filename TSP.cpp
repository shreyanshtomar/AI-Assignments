...
int builMST(vector<int> vertices,vector<char> nodesLeft)
{
    /*Function returns the length of the minimumSpanningTree for the
...
int calculateHeuristic(vector<int> vertices,vector<char> nodesLeft,int currentCityForExpansion)
{
    ...
    int mst;
        ...
        mst=builMST(vertices,nodesLeft);
