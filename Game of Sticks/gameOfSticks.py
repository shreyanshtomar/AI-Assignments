...
def continue_game(): #User continues to play after a game
    continue_game = ''
    continue_bool = False
    while True:
    ...
    while True:
        ...
        try:
            ...
            if 1 <= game_mode <= 2:
                ...
                print('Please choose the game type number (1 or 2)')
                continue
        except:
            print('Please choose the game type by number (1 or 2)')
            continue
    return game_mode
